...
// The upload action only ever accepts .pdf/.doc/.docx, so these three MIME values are exhaustive.
const FILE_TYPES: Record<string, string> = { "application/pdf": "PDF", "application/vnd.openxmlformats-officedocument.wordprocessingml.document": "Word (.docx)", "application/msword": "Word (.doc)" };
