/**
 * DRAFT — mock UI only.
 * Ported from drafts/src/prospect-data.jsx for prototype review. Placeholder data
 * for the Prospect Pipeline screen; no real data layer or actions are wired up yet.
 */
import type { IconName } from "./icons";

export type StaffKey = "eman" | "matt" | "joy" | "bea";
export const PP_STAFF: Record<StaffKey, string> = {
  eman: "Eman Reyes",
  matt: "Matt Nassr",
  joy: "Joy Mercado",
  bea: "Bea Lim",
...
/** Product → colour coding (hex, used inline for dots/bars). */
export const PP_PRODUCTS: Record<string, string> = {
  "Blue Royale": "#059669",
  Select: "#2563eb",
...
export const PP_PIPELINE: PipelineStage[] = [
...
export const PP_COLUMNS: KanbanColumn[] = [
...
export const PP_PROSPECTS: Prospect[] = [
  // New Inquiry
...
export const PP_PROPOSALS: Proposal[] = [
...
export const PP_PRODUCT_INTEREST: ProductInterestRow[] = [
...
export type Urgency = "today" | "over" | "soon";
...
export const PP_FOLLOWUPS: FollowUp[] = [
...
export type PpActivityType =
  | "convert" | "proposal_sent" | "discovery" | "brochure" | "proposal_req" | "inquiry" | "intake";
export interface PpActivity {
  type: PpActivityType;
  who: string;
  text: string;
  time: string;
}
export const PP_ACTIVITY: PpActivity[] = [
...
export const PP_QUICK: QuickAction[] = [
